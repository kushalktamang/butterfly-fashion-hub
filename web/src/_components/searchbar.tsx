...
const SearchBar = () => {
  ...
  return (
    <div className="bg-cream border-pink-100 px-4 sm:px-8 py-3">
      <div className="max-w-3xl mx-auto flex items-center gap-2 bg-cream border border-gray-200 rounded px-3 sm:px-4 py-2">
        <TbSearch className="w-5 h-5 text-charcol shrink-0" />
        <input
          type="text"
          value={search}
          onChange={(e) => {
        ...
        >
          <TbX className="w-5 h-5 text-charcol" />
        </button>
      </div>
    </div>
  );
