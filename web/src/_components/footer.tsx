...
const Footer = () => {
  return (
    <div className="bg-charcol text-cream">
      <footer className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-10 text-sm px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] p-10">
        <div>
          <img src={assets.logo} alt="logo" className="mb-2 w-45" />
          {/* quick social links */}
          <div className="px-4">
