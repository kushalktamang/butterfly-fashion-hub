  ...
  return (
    <>
      <div className="px-6 md:px-10 pt-5 pb-20">
        {/* Exchange Policy Box */}
        <div className="bg-cream shadow-lg rounded-2xl p-8 max-w-4xl mx-auto">
          <div className="text-5xl font-bold text-center mb-6">
            <Title textOne={"Exchange"} textTwo={"Policy"} />
          </div>

          {/* Change of Mind Section */}
          <h2 className="text-2xl font-semibold mb-2">Change of Mind</h2>
          ...
          <h2 className="text-3xl font-semibold mb-2">Damaged or Faulty Products</h2>
          <p className="text-gray-500 mb-4">
